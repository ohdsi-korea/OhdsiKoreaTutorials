TicagrelorVsClopidogrelMiniReplica
==============================
...
2. In `R`, use the following `devtools` command to install the TicagrelorVsClopidogrelMiniReplica package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	```r
	library(TicagrelorVsClopidogrelMiniReplica)
	...
	outputFolder <- "c:/TicagrelorVsClopidogrelMiniReplica"
...
License
=======
The TicagrelorVsClopidogrelMiniReplica package is licensed under Apache License 2.0

Development
===========
TicagrelorVsClopidogrelMiniReplica was developed in ATLAS and R Studio.
