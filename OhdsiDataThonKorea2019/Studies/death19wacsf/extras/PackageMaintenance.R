...
OhdsiRTools::checkUsagePackage("death19wacsf")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/death19wacsf.pdf")
shell("R CMD Rd2pdf ./ --output=extras/death19wacsf.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("death19wacsf")
