...
OhdsiRTools::checkUsagePackage("team3")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/team3.pdf")
shell("R CMD Rd2pdf ./ --output=extras/team3.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("team3")
