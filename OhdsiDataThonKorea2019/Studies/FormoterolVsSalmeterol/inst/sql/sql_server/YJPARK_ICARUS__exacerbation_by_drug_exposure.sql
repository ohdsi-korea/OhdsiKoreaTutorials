...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (920625,19016866,19095136,1506426,1550560,19019893)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (920625,19016866,19095136,1506426,1550560,19019893)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1518258)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1518258)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4191479,317009,4206340,4279553,4145497,4110051)and invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1518258,920625,19016866,19095136,1506426,1550560,19019893,19074185,40224101,19006963,40231785,35606533,35606538,19080181,42902110,40234030,40234038,42629020)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (1518258,920625,19016866,19095136,1506426,1550560,19019893,19074185,40224101,19006963,40231785,35606533,35606538,19080181,42902110,40234030,40234038,42629020)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (9203,9201)and invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (19074185,40224101,19006963,40231785,35606533,35606538,19080181,42902110,40234030,40234038,42629020)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (19074185,40224101,19006963,40231785,35606533,35606538,19080181,42902110,40234030,40234038,42629020)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (9203)and invalid_reason is null
...
(
  ...
  (
    ...
    (
      --cteEndDates
      select PERSON_ID, DATEADD(day,-1 * 1,EVENT_DATE) as END_DATE -- unpad the end date by 1
      FROM
      (
				...
				(
					...
					-- add the end dates with NULL as the row number, padding the end dates by 1 to allow a grace period for overlapping ranges.
					select PERSON_ID, DATEADD(day,1,DRUG_EXPOSURE_END_DATE), 1 as EVENT_TYPE, NULL
					FROM #drugTarget D
				) RAWDATA
      ) E
