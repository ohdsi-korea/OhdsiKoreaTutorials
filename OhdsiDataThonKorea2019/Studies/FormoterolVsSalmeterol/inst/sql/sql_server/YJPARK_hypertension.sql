...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (320128,4342143)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (320128,4342143)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4152194)and invalid_reason is null
...
WHERE C.ordinal = 1
AND C.value_as_number >= 140.0000
