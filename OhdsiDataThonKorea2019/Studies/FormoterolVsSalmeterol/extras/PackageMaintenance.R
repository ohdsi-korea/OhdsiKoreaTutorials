...
OhdsiRTools::checkUsagePackage("FormoterolVsSalmeterol")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/FormoterolVsSalmeterol.pdf")
shell("R CMD Rd2pdf ./ --output=extras/FormoterolVsSalmeterol.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "FormoterolVsSalmeterol")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("FormoterolVsSalmeterol")
