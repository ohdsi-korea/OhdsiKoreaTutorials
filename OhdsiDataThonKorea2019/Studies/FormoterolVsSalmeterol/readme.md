...
2. In 'R', use the following code to install the FormoterolVsSalmeterol package:
...
3. Once installed, you can execute the study by modifying and using the following code:
	...
	```r
	library(FormoterolVsSalmeterol)
	...
	outputFolder <- "c:/FormoterolVsSalmeterol"
...
License
=======
The FormoterolVsSalmeterol package is licensed under Apache License 2.0


Development
===========
FormoterolVsSalmeterol was developed in ATLAS and R Studio.
