...
OhdsiRTools::checkUsagePackage("AUSOM")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/AUSOM.pdf")
shell("R CMD Rd2pdf ./ --output=extras/AUSOM.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("AUSOM")
