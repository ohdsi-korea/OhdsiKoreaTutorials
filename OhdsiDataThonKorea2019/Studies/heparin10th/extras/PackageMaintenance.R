...
OhdsiRTools::checkUsagePackage("heparin10th")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/heparin10th.pdf")
shell("R CMD Rd2pdf ./ --output=extras/heparin10th.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("heparin10th")
