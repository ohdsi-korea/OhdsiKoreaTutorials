...
OhdsiRTools::checkUsagePackage("KYR2")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/KYR2.pdf")
shell("R CMD Rd2pdf ./ --output=extras/KYR2.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("KYR2")
