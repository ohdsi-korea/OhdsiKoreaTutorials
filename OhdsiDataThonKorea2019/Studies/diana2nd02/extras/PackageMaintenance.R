...
OhdsiRTools::checkUsagePackage("diana2nd02")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/diana2nd02.pdf")
shell("R CMD Rd2pdf ./ --output=extras/diana2nd02.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("diana2nd02")
