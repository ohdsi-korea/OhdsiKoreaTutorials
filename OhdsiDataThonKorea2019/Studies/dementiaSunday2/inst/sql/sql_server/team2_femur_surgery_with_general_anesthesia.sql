...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4174669)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4174669)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4313570,4286744)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4313570,4286744)
  and c.invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (4078199,4332593)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (4078199,4332593)
  and c.invalid_reason is null
...
WHERE YEAR(C.procedure_date) - P.year_of_birth >= 60
...
select event_id, person_id, 
  case when DATEADD(day,90,start_date) > start_date then DATEADD(day,90,start_date) else start_date end as end_date
INTO #strategy_ends
