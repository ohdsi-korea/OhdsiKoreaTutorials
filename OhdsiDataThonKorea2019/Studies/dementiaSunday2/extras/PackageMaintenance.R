...
OhdsiRTools::checkUsagePackage("dementiaSunday2")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/dementiaSunday2.pdf")
shell("R CMD Rd2pdf ./ --output=extras/dementiaSunday2.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("dementiaSunday2")
