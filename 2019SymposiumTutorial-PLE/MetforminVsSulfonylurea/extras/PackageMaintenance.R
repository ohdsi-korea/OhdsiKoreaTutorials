...
OhdsiRTools::checkUsagePackage("MetforminVsSulfonylurea")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/MetforminVsSulfonylurea.pdf")
shell("R CMD Rd2pdf ./ --output=extras/MetforminVsSulfonylurea.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "MetforminVsSulfonylurea")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("MetforminVsSulfonylurea")
