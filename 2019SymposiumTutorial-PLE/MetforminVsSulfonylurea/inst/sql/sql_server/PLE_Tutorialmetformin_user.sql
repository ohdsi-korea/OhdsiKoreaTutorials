...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (1597756,19059796,1559684)
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (46221581,1596977,1550023,1567198,1502905)
...
WHERE YEAR(C.drug_era_start_date) - P.year_of_birth >= 30
AND C.ordinal = 1
