...
2. In `R`, use the following `devtools` command to install the CohortMethodAceiVsThz package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	outputFolder <- "c:/CohortMethodAceiVsThz"
...
License
=======
The CohortMethodAceiVsThz package is licensed under Apache License 2.0

Development
===========
CohortMethodAceiVsThz was developed in ATLAS and R Studio.
