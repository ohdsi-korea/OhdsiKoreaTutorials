...
OhdsiRTools::checkUsagePackage("SUhypoglycemia")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/SUhypoglycemia.pdf")
shell("R CMD Rd2pdf ./ --output=extras/SUhypoglycemia.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("SUhypoglycemia")
