...
OhdsiRTools::checkUsagePackage("ClopidogrelGIbleeding")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/ClopidogrelGIbleeding.pdf")
shell("R CMD Rd2pdf ./ --output=extras/ClopidogrelGIbleeding.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("ClopidogrelGIbleeding")
